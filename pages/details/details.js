...
Page({
  data: {
    items: [
      {
        content:'测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动1',
      },
      {
        content: '测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动2',
      },
      {
        content: '测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动,测试向左滑动3',
      },
      {
  ...
  backfill: function (e) {
    ...
    getPy: function(e) {
      this.setData({
          hidden: false,
          PYcolor:e.currentTarget.id
      })
  },
  setPy: function(e) {
      this.setData({
          hidden: true,
          scrollTopId: this.data.PYcolor
      })
  },
    //触发全部开始选择
    tStart: function() {
